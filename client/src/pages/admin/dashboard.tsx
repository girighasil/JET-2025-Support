...
export default function AdminDashboard() {
  ...
  const { data: recentEnrollments = [], isLoading: isEnrollmentsLoading } =
    useQuery({
  ...
  const enrollmentColumns = [
    ...
    },
    {
      ...
      cell: ({ row }: any) => {
        return (
          <a
            href={`/admin/manage-students?id=${row.original.id}`}
    ...
    >
      ...
      <div className="mb-8">
        ...
        {isEnrollmentsLoading ? (
          ...
          <DataTable columns={enrollmentColumns} data={recentEnrollmentsData} />
        )}
      </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span>
                        ...
                        at {format(new Date(session.scheduledFor), "h:mm a")}
                      </span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
