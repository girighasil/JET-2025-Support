          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="space-y-2">
                ...
                <div>{formatDate(currentAttempt.submittedAt || currentAttempt.startedAt)}</div>
              </div>
              <div className="space-y-2">
                      ...
                      <div className="flex-1">
                        ...
                        {question.type === 'truefalse' && (
                          <div className="pl-4 space-y-2 mb-3">
                            {['true', 'false'].map((value) => {
                              ...
                              const isCorrectAnswer = question.correctAnswer === boolValue;
                        ...
                        {question.type === 'fillblank' && (
                          <div className="pl-4 mb-3">
                            <div className="flex items-start gap-2">
                              <div className="font-medium min-w-[120px]">Your Answer:</div>
                              <div className={isCorrect ? 'text-green-700' : 'text-red-700'}>
                                {userAnswer || 'No answer provided'}
                              </div>
                            </div>
                            <div className="flex items-start gap-2 mt-2">
                              <div className="font-medium min-w-[120px]">Correct Answer:</div>
                        ...
                        {question.type === 'subjective' && (
                          <div className="pl-4 mb-3">
                            ...
                            <div className="font-medium mb-1">Key Concepts Expected:</div>
                            <div className="flex flex-wrap gap-2">
                              {question.correctAnswer.map((keyword: string, i: number) => (
                                <span 
                                  key={i}
