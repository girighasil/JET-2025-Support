...
export default function HeroSection() {
  ...
  return (
    <div className="relative">
      ...
      {/* Main Hero Section */}
      <section className="py-10 md:py-16 bg-gradient-to-b from-white to-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8 max-w-6xl mx-auto">
              <div className="bg-amber-100 p-6 rounded-lg border border-amber-200">
                <h2 className="text-xl font-bold mb-4 text-amber-800 flex items-center justify-center">
                ...
                <div className="mt-6 bg-amber-200 p-3 rounded-lg">
                  <div className="flex justify-between items-center">
                    <strong className="text-amber-800">📞 Contact Number:</strong>
                ...
                <div className="mt-4">
                  <Button 
                    ...
                    onClick={() => window.open('https://whatsapp.com/channel/0029VbAudzTHbFV5ppcj0b07', '_blank')}
                  >
                    Join WhatsApp
                  </Button>
                </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm text-gray-600 mb-1">Type the characters you see in the picture below</label>
                    <div className="flex space-x-2">
                      ...
                      />
                      <div className="bg-gray-200 p-2 rounded-md flex items-center justify-center min-w-[100px]">
                        <span className="font-mono text-gray-700">56VUM</span>
                  ...
                  <div className="text-center mt-2">
                    <p className="text-yellow-600 text-sm flex items-center justify-center">
